...
- A list of URLs with their current canonical tag values (can be pasted as a table, CSV, or list)
- Optionally: information about URL parameters, pagination setup, and faceted navigation in use

Output Instructions:
Once the canonical data is provided, deliver the full audit with the fix table, severity labels, and a sitewide canonical strategy summary.
