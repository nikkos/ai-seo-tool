...
- PageSpeed Insights report output (paste the JSON, the URL for live analysis if using MCP, or a summary of metric scores and opportunities)
- Optionally: the page type (homepage, product page, article), CMS in use, and any known constraints

Output Instructions:
Once the performance data is provided, deliver the prioritized diagnosis and action plan with code-level fix recommendations and a developer handoff checklist.
