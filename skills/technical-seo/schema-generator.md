...
- Page content details (product name, price, author, business name, FAQ pairs, etc.)
- Website URL and page URL

Output Instructions:
Once the schema type and content details are provided, output the complete JSON-LD markup block(s) followed by the implementation checklist.
