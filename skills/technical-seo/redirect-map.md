...
- A list of old URLs and their new destination URLs (paste as a table, CSV, or list)
- The server type (Apache, Nginx, Cloudflare, Vercel, etc.)
- Optionally: backlink data or traffic data for the old URLs, and whether this is a full site migration or a partial restructure

Output Instructions:
Once the URL data and server type are provided, output the CSV redirect map, server configuration rules, and migration checklist in separate clearly labeled code blocks.
