...
- The full page content (paste directly)
- The primary query or topic this page targets in AI search
- The page URL
- Optionally: examples of current AI-generated answers for the target query (to compare against), and brand-voice.md for tone and language matching (write all output in the language specified in brand-voice.md)

Output Instructions:
Once the page content and target query are provided, produce the full GEO audit with dimension scores, specific fixes, the GEO Readiness Score, and the top 5 improvement priorities.
