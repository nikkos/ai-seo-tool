...
- Product/service category and primary use cases
- Top 3–5 competitors
- Target audience
- Optionally: existing content URLs to check for citation, specific AI tools to focus on, and known incorrect information appearing in AI answers

Output Instructions:
Once the brand details are provided, produce the full query test set with evaluation framework, run the tests if MCP web access is available, produce the brand visibility report, and output the top 10 improvement actions.
