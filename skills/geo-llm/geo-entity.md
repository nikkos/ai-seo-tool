...
- Entity name and type (brand, product, person, organization)
- Core facts: what it is, what it does, who it serves, founding details, key people
- Website URL
- Optionally: existing About page content, Wikipedia article (if one exists), competitor entities to reference, and any awards or credentials

Output Instructions:
Once the entity details are provided, produce all five definition assets, the JSON-LD schema block, and the distribution checklist.
