...
- A list of image filenames or URLs with their current alt text (or "none" if missing)
- The target keyword or topic of the page
- Optionally: the page URL, page type (blog post, product page, homepage), and any brand naming conventions

Output Instructions:
Once the image list and page context are provided, produce the alt text recommendation table and the site-type-specific best practices note.
